...
# List of locations
locations = ['Bali', 'Japan', 'Philippines', 'Iceland']
print(locations)

# sorted(): allows you display the list in alphabetical order without modifying the original list
print(sorted(locations))
print(locations)

# sorted() function to display list in reverse alphabetical order
