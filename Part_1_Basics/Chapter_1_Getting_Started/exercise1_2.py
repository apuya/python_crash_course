...
print("Hello Python world!") # Prints out Hello Python world!

# typo within the parentheses, no errror. Prints out Hello Python word!
print("Hello Python word!") 

# typo outside the parentheses, "Priint" Creates a syntax error
# Priint("Hello Python world!") 