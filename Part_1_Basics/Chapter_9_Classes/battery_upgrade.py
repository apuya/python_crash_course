...
# battery size and set the capacity to 100 if it isn’t already. Make an 
...
class Battery:
    ...
    def upgrade_battery(self):
        """
        Check battery size and set default capacity.
        """
        if self.battery_size == 75:
            battery_size = 100
            print("Battey size upgraded to 100 kwh.")
        else:
            print("Battery size is already 100 kwh.")
...
print("Make an electric car, and checking the battery:")
