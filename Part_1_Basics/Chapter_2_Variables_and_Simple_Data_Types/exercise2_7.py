...
#   Print the name once, so the whitespace around the name is displayed. Then print the name using 
...
# Stripping functions: temprarily removes extra space from the left, right, or both sides
